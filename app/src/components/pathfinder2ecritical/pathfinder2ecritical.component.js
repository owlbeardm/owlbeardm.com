...
function Pathfinder2eCriticalController($log) {
  ...
  ctrl.toWound = [
    ...
    [1, 2, 4, 5, 7, 8, 9, 10, 12, 14, 14],
    [1, 3, 4, 6, 8, 9, 10, 11, 13, 14, 15],
    [1, 3, 5, 7, 8, 9, 11, 12, 14, 15, 15],
    [2, 4, 5, 8, 9, 10, 12, 13, 14, 15, 15],
    [2, 4, 6, 9, 10, 11, 12, 13, 14, 15, 15],
    [2, 5, 7, 10, 11, 12, 13, 14, 15, 15, 15],
    [3, 5, 8, 11, 11, 12, 13, 14, 15, 15, 15],
    [3, 6, 9, 11, 12, 13, 14, 14, 15, 15, 15],
    [3, 6, 10, 12, 12, 13, 14, 15, 15, 15, 15],
    [4, 7, 10, 12, 13, 14, 14, 15, 15, 15, 15],
    [4, 7, 11, 13, 13, 14, 14, 15, 15, 15, 15],
    [4, 8, 11, 13, 14, 14, 15, 15, 15, 15, 15],
    [5, 8, 12, 14, 14, 14, 15, 15, 15, 15, 15],
    [5, 9, 12, 14, 14, 15, 15, 15, 15, 15, 15],
    [5, 9, 12, 14, 15, 15, 15, 15, 15, 15, 15],
    [6, 10, 13, 15, 15, 15, 15, 15, 15, 15, 15],
    [6, 10, 13, 15, 15, 15, 15, 15, 15, 15, 15],
    [6, 11, 14, 15, 15, 15, 15, 15, 15, 15, 15],
    [7, 13, 15, 15, 15, 15, 15, 15, 15, 15, 15],
  ];
  ctrl.toWoundPlace = [
    "Head",
    "Right Arm",
